...
import recarguide.settings_local as local
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'recarguide.common.context_processors.stripe_settings',
            ],
        },
    },
]

WSGI_APPLICATION = 'recarguide.wsgi.application'
...
AWS_S3_ACCESS_KEY_ID = local.AWS_S3_ACCESS_KEY_ID
